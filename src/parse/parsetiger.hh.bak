  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_exps = 57,                             // exps
        S_58_exps_aux = 58,                      // exps.aux
        S_exp = 59,                              // exp
        S_elserule = 60,                         // elserule
        S_61_exp_1 = 61,                         // exp.1
        S_62_exp_2 = 62,                         // exp.2
        S_lvalue = 63,                           // lvalue
        S_exp3 = 64,                             // exp3
        S_65_exp3_1 = 65,                        // exp3.1
        S_chunks = 66,                           // chunks
        ...
        S_typeid = 73,                           // typeid
        S_vardec = 74,                           // vardec
        S_funchunk = 75,                         // funchunk
        S_colontypeid = 76                       // colontypeid
      };
    };
...
switch (yykind)
    ...
    parser (::parse::TigerDriver& td_yyarg, ::parse::Lexer& lexer_yyarg);
    ~parser ();
