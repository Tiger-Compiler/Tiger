...
namespace parse
{
    ...
    ast_type TigerDriver::parse_()
    {
        ...
        // DONE: Some code was deleted here (Initialize Lexer and enable scan
        // traces).
        Lexer lexer(*in);
        scan_trace(true);

        // DONE: Some code was deleted here (Initialize the parser and enable
        // parse traces).
    ...
    ast_type TigerDriver::parse(Tweast& s)
    {
    ...
    const misc::error& TigerDriver::error_get() const
    {
        return error_;
    }
