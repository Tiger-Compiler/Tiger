...
namespace misc
{
    ...
    template <class T, class N>
    N map<T, N>::operator()(const T& t) const
    {
    ...
    template <class T, class N>
    N& map<T, N>::operator[](const T& t)
    {
        return map_[t];
    }

    template <class T, class N>
    typename map<T, N>::iterator map<T, N>::begin()
    {
        return map_.begin();
    }

    template <class T, class N>
    typename map<T, N>::iterator map<T, N>::end()
    {
        return map_.end();
    }
    ...
    template <class T, class N>
    void map<T, N>::insert(const map& other)
    {
    ...
    template <class T, class N>
    bool map<T, N>::empty() const
    {
        return map_.empty();
    }

    template <class T, class N>
    size_t map<T, N>::size() const
    {
        return map_.size();
    }

    template <class T, class N>
    N map<T, N>::take(const T& t)
    {
        auto ires = xfind(t);
        N elt = ires->second;
        map_.erase(ires);
