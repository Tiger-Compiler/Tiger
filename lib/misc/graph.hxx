...
namespace misc
{
    ...
    graph<Orientation, VertexLabel, EdgeLabel>::print(std::ostream& ostr) const
    {
        ...
        std::string graphtype =
            boost::is_undirected(*this) ? "graph" : "digraph";
    ...
    template <typename Orientation, typename VertexLabel, typename EdgeLabel>
    void
    graph<Orientation, VertexLabel, EdgeLabel>::print(std::string file) const
    {
        std::ofstream ofs;
    ...
    template <typename Orientation, typename VertexLabel, typename EdgeLabel>
    void graph<Orientation, VertexLabel, EdgeLabel>::name_set(
    ...
    void directed_graph<VertexLabel, EdgeLabel>::edge_add(
    ...
    std::vector<
        typename directed_graph<NodeLabel, EdgeLabel>::vertex_descriptor>
